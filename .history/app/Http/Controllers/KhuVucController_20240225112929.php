...
class KhuVucController extends Controller
{
    ...
    public function createDanhMuc(CreateKhuVucRequest $request)
    {
        $data = $request->all();
        KhuVuc::create($data);
    ...
    public function updateDanhMuc(UpdateKhuVucRequest $request)
    {
        $data = $request->all();
    ...
    public function deleteDanhMuc(CheckIdKhuVucRequest $request)
    {
        $danh_muc = KhuVuc::find($request->id);
