                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        <strong>Thank you for using the service at the
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h2
                                                                        ...
                                                                        Code Bill <a style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:26px">{{ $data['code_bill'] }}</a>
                                                                        Paid!&nbsp;</h2>
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    @foreach ($data['chi_tiet'] as $value)
                                        <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <strong>Dish: {{ $value->food_name }}</strong></p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <p
                                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                        Percentage reduction: {{ $value->phan_tram_giam }}</p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-r"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Subtotal:&nbsp;<strong>{{$data['subtotal']}}</strong><br>Percent decrease:&nbsp;<strong>{{$data['phan_tram_giam']}}</strong><br>Total:&nbsp;<strong>{{$data['total']}}</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Customer: <strong>{{ $data['email'] }}</strong></p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
